...
* [Tiled](https://www.mapeditor.org/) map/level editor if you want to edit existing scenes/rooms or make new ones.
  * [Here](https://drive.google.com/file/d/1Bqs43iioL3xwoAX8yY4hsE3nZOiCQCpX/view?usp=sharing) is the Google Drive download for all the Tiled map files that ZALiA uses.
