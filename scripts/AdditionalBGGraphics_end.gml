...
var _exists = false;
    ...
    _exists=variable_instance_exists(id,"dg_xy");
if (_exists) _exists = !is_undefined(    dg_xy);
if (_exists) _exists = ds_exists(        dg_xy,ds_type_grid);
if (_exists)           ds_grid_destroy(  dg_xy);
if (_exists)                             dg_xy=undefined;
