...
var _exists = false;
    ...
    _exists = variable_instance_exists(id,  "dg_Blocks");
if (_exists) _exists =      !is_undefined(   dg_Blocks);
if (_exists) _exists =       ds_exists(      dg_Blocks,ds_type_grid);
if (_exists)                 ds_grid_destroy(dg_Blocks);
if (_exists)                                 dg_Blocks=undefined;
