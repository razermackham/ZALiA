...
var _exists = false;
    ...
    _exists = variable_instance_exists(id,  "dg_kids");
if (_exists) _exists =      !is_undefined(   dg_kids);
if (_exists) _exists =       ds_exists(      dg_kids,ds_type_grid);
if (_exists)                 ds_grid_destroy(dg_kids);
if (_exists)                                 dg_kids=undefined;
