...
/*
    _exists = variable_instance_exists(id,  "dl_gate");
if (_exists) _exists =      !is_undefined(   dl_gate);
if (_exists) _exists =       ds_exists(      dl_gate,ds_type_list);
if (_exists)                 ds_list_destroy(dl_gate);
if (_exists)                                 dl_gate=undefined;
*/
