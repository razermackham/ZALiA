...
var _exists = false;
    ...
    _exists = variable_instance_exists(id,  "dg_cling");
if (_exists) _exists =      !is_undefined(   dg_cling);
if (_exists) _exists =       ds_exists(      dg_cling,ds_type_grid);
if (_exists)                 ds_grid_destroy(dg_cling);
if (_exists)                                 dg_cling=undefined;
