...
var _exists = false;
    ...
    _exists = variable_instance_exists(id,  "dg_Attack3");
if (_exists) _exists =      !is_undefined(   dg_Attack3);
if (_exists) _exists =       ds_exists(      dg_Attack3, ds_type_grid);
if (_exists)                 ds_grid_destroy(dg_Attack3);
if (_exists)                                 dg_Attack3 = undefined;
