/// Challenge_BlockConfiguration_end()
...
var          _exists = false;
             ...
             _exists = variable_instance_exists(id,  "dg_config");
if (_exists) _exists =               !is_undefined(   dg_config);
if (_exists) _exists =                ds_exists(      dg_config, ds_type_grid);
if (_exists)                          ds_grid_destroy(dg_config);
if (_exists)                                          dg_config = undefined;
