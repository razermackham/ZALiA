...
var          _exists = false;
             ...
             _exists = variable_instance_exists(id,  "dg_status");
if (_exists) _exists =               !is_undefined(   dg_status);
if (_exists) _exists =                ds_exists(      dg_status, ds_type_grid);
if (_exists)                          ds_grid_destroy(dg_status);
if (_exists)                                          dg_status = undefined;
