...
var          _exists = false;
             ...
             _exists = variable_instance_exists(id,  "dg_torches");
if (_exists) _exists =               !is_undefined(   dg_torches);
if (_exists) _exists =                ds_exists(      dg_torches, ds_type_grid);
if (_exists)                          ds_grid_destroy(dg_torches);
if (_exists)                                          dg_torches = undefined;
