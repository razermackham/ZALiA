/// Challenge_PushableMatching1_end()
...
var          _exists = false;
    ...
    _exists = variable_instance_exists(id,  "dg_Blocks1");
if (_exists) _exists =      !is_undefined(   dg_Blocks1);
if (_exists) _exists =       ds_exists(      dg_Blocks1, ds_type_grid);
if (_exists)                 ds_grid_destroy(dg_Blocks1);
if (_exists)                                 dg_Blocks1 = undefined;

    _exists = variable_instance_exists(id,  "dg_Switches");
if (_exists) _exists =      !is_undefined(   dg_Switches);
if (_exists) _exists =       ds_exists(      dg_Switches, ds_type_grid);
if (_exists)                 ds_grid_destroy(dg_Switches);
if (_exists)                                 dg_Switches = undefined;
/*
    _exists = variable_instance_exists(id,  "dg_Statues");
if (_exists) _exists =      !is_undefined(   dg_Statues);
if (_exists) _exists =       ds_exists(      dg_Statues, ds_type_grid);
if (_exists)                 ds_grid_destroy(dg_Statues);
if (_exists)                                 dg_Statues = undefined;
*/
