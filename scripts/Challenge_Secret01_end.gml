...
var _exists = false;
    ...
    _exists=variable_instance_exists(id,"dl_MOVE_TO_X");
if (_exists) _exists = !is_undefined(    dl_MOVE_TO_X);
if (_exists) _exists = ds_exists(        dl_MOVE_TO_X,ds_type_list);
if (_exists)           ds_list_destroy(  dl_MOVE_TO_X);
if (_exists)                             dl_MOVE_TO_X=undefined;
