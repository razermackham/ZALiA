...
/*
    _exists = variable_instance_exists(id,  "dl_spell_hist");
if (_exists) _exists =      !is_undefined(   dl_spell_hist);
if (_exists) _exists =       ds_exists(      dl_spell_hist, ds_type_list);
if (_exists)                 ds_list_destroy(dl_spell_hist);
if (_exists)                                 dl_spell_hist = undefined;
*/
