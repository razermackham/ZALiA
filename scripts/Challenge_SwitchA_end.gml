...
//              _exists = variable_instance_exists(id,  "dg_switch");
// if (_exists) _exists =                ds_exists(      dg_switch, ds_type_grid);
// if (_exists)                          ds_grid_destroy(dg_switch);
// if (_exists)                                          dg_switch = undefined;
