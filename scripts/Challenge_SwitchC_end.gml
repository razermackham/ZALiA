...
var          _exists = false;
             ...
             _exists = variable_instance_exists(id,  "dl_switch");
if (_exists) _exists =               !is_undefined(   dl_switch);
if (_exists) _exists =                ds_exists(      dl_switch, ds_type_list);
if (_exists)                          ds_list_destroy(dl_switch);
if (_exists)                                          dl_switch = undefined;
