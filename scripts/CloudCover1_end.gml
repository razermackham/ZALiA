...
var          _exists = false;
    ...
    _exists = variable_instance_exists(id,  "dg_CloudLayers");
if (_exists) _exists =      !is_undefined(   dg_CloudLayers);
if (_exists) _exists =       ds_exists(      dg_CloudLayers, ds_type_grid);
if (_exists)                 ds_grid_destroy(dg_CloudLayers);
if (_exists)                                 dg_CloudLayers = undefined;
