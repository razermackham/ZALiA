...
var          _exists = false;
    ...
    _exists = variable_instance_exists(id,  "dg_cloud");
if (_exists) _exists =      !is_undefined(   dg_cloud);
if (_exists) _exists =       ds_exists(      dg_cloud, ds_type_grid);
if (_exists)                 ds_grid_destroy(dg_cloud);
if (_exists)                                 dg_cloud = undefined;
