...
var _exists;
    ...
    _exists = variable_instance_exists(id,  'dl_Tyell_SPAWN_DK');
if (_exists) _exists =      !is_undefined(   dl_Tyell_SPAWN_DK);
if (_exists) _exists =       ds_exists(      dl_Tyell_SPAWN_DK, ds_type_list);
if (_exists)                 ds_list_destroy(dl_Tyell_SPAWN_DK);
if (_exists)                                 dl_Tyell_SPAWN_DK = undefined;




    _exists = variable_instance_exists(id,  'dg_Block_Crumble_TSRC');
if (_exists) _exists =      !is_undefined(   dg_Block_Crumble_TSRC);
if (_exists) _exists =       ds_exists(      dg_Block_Crumble_TSRC, ds_type_grid);
if (_exists)                 ds_grid_destroy(dg_Block_Crumble_TSRC);
if (_exists)                                 dg_Block_Crumble_TSRC = undefined;
