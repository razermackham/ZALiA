...
var _exists;
             ...
             _exists = variable_instance_exists(id,  "dg_triforce");
if (_exists) _exists =               !is_undefined(   dg_triforce);
if (_exists) _exists =                ds_exists(      dg_triforce, ds_type_grid);
if (_exists)                          ds_grid_destroy(dg_triforce);
if (_exists)                                          dg_triforce = undefined;
