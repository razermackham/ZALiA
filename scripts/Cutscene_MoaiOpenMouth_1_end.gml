...
var _exists = false;
    ...
    _exists = variable_instance_exists(id,  "dg_TurnedIn");
if (_exists) _exists =      !is_undefined(   dg_TurnedIn);
if (_exists) _exists =       ds_exists(      dg_TurnedIn, ds_type_grid);
if (_exists)                 ds_grid_destroy(dg_TurnedIn);
if (_exists)                                 dg_TurnedIn = undefined;
