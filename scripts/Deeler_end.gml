...
var _exists = false;
    ...
    _exists = variable_instance_exists(id,  "dl_Web_y");
if (_exists) _exists =      !is_undefined(   dl_Web_y);
if (_exists) _exists =       ds_exists(      dl_Web_y,ds_type_list);
if (_exists)                 ds_list_destroy(dl_Web_y);
if (_exists)                                 dl_Web_y=undefined;
