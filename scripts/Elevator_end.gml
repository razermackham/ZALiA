...
var _exists = false;
    ...
    _exists = variable_instance_exists(id,  "dl_exit");
if (_exists) _exists =      !is_undefined(   dl_exit);
if (_exists) _exists =       ds_exists(      dl_exit,ds_type_list);
if (_exists)                 ds_list_destroy(dl_exit);
if (_exists)                                 dl_exit=undefined;
