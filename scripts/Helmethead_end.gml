...
var _exists = false;
    ...
    _exists = variable_instance_exists(id,  "dl_Head_SPRITES");
if (_exists) _exists =      !is_undefined(   dl_Head_SPRITES);
if (_exists) _exists =       ds_exists(      dl_Head_SPRITES, ds_type_list);
if (_exists)                 ds_list_destroy(dl_Head_SPRITES);
if (_exists)                                 dl_Head_SPRITES = undefined;
