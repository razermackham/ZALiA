...
var          _exists = false;
             ...
             _exists = variable_instance_exists(id,  "dl_SEQ");
if (_exists) _exists =               !is_undefined(   dl_SEQ);
if (_exists) _exists =                ds_exists(      dl_SEQ, ds_type_list);
if (_exists)                          ds_list_destroy(dl_SEQ);
if (_exists)                                          dl_SEQ = undefined;





             _exists = variable_instance_exists(id,  "dg_SEQ");
if (_exists) _exists =               !is_undefined(   dg_SEQ);
if (_exists) _exists =                ds_exists(      dg_SEQ, ds_type_grid);
if (_exists)                          ds_grid_destroy(dg_SEQ);
if (_exists)                                          dg_SEQ = undefined;
