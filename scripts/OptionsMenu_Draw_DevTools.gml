...
for(_i=0; _i<DevTools_COUNT; _i++)
{
    ...
    _xl = TextArea1_xl;
    draw_text_(_xl,_yt1, _text, _font, PI_MENU);
    ...
    switch(_i){
    case DevTools_SET_DEFAULT:    {_yt1+=_DIST1; break;} // extra spacing
    case DevTools_BGR_BLACK:      {_yt1+=_DIST1; break;} // extra spacing
    case DevTools_INVULNERABILITY:{_yt1+=_DIST1; break;} // extra spacing
    }
}
