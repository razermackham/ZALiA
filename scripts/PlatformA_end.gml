...
var          _exists = false;
             ...
             _exists = variable_instance_exists(id,  "dg_path");
if (_exists) _exists =               !is_undefined(   dg_path);
if (_exists) _exists =                ds_exists(      dg_path, ds_type_grid);
if (_exists)                          ds_grid_destroy(dg_path);
if (_exists)                                          dg_path = undefined;
