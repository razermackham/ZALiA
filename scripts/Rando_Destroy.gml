...
var _exists = false;
    ...
    _exists = variable_instance_exists(id,  "dm_LOCATIONS");
if (_exists) _exists =      !is_undefined(   dm_LOCATIONS);
if (_exists) _exists =       ds_exists(      dm_LOCATIONS,ds_type_map);
if (_exists)                 ds_map_destroy( dm_LOCATIONS);
if (_exists)                                 dm_LOCATIONS=undefined;
