...
var _exists = false;
    ...
    _exists = variable_instance_exists(id,  "dg_SPEEDS");
if (_exists) _exists =      !is_undefined(   dg_SPEEDS);
if (_exists) _exists =       ds_exists(      dg_SPEEDS,ds_type_grid);
if (_exists)                 ds_grid_destroy(dg_SPEEDS);
if (_exists)                                 dg_SPEEDS=undefined;
