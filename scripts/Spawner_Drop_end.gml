...
var _exists = false;
    ...
    _exists = variable_instance_exists(id,  "dg_XY_RM");
if (_exists) _exists =      !is_undefined(   dg_XY_RM);
if (_exists) _exists =       ds_exists(      dg_XY_RM,ds_type_grid);
if (_exists)                 ds_grid_destroy(dg_XY_RM);
if (_exists)                                 dg_XY_RM=undefined;

    _exists = variable_instance_exists(id,  "dg_XY_TS");
if (_exists) _exists =      !is_undefined(   dg_XY_TS);
if (_exists) _exists =       ds_exists(      dg_XY_TS,ds_type_grid);
if (_exists)                 ds_grid_destroy(dg_XY_TS);
if (_exists)                                 dg_XY_TS=undefined;
