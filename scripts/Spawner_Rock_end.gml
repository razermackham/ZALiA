...
var _exists = false;
    ...
    _exists = variable_instance_exists(id,  "dl_YOFF");
if (_exists) _exists =      !is_undefined(   dl_YOFF);
if (_exists) _exists =       ds_exists(      dl_YOFF,ds_type_list);
if (_exists)                 ds_list_destroy(dl_YOFF);
if (_exists)                                 dl_YOFF=undefined;
