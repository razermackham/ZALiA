...
var          _exists = false;
             ...
             _exists = variable_instance_exists(id,  "dg_chain_link_xy");
if (_exists) _exists =               !is_undefined(   dg_chain_link_xy);
if (_exists) _exists =                ds_exists(      dg_chain_link_xy, ds_type_grid);
if (_exists)                          ds_grid_destroy(dg_chain_link_xy);
if (_exists)                                          dg_chain_link_xy = undefined;
*/
