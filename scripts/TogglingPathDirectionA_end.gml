...
var          _exists = false;
             ...
             _exists = variable_instance_exists(id,  "dg_doors");
if (_exists) _exists =               !is_undefined(   dg_doors);
if (_exists) _exists =                ds_exists(      dg_doors, ds_type_grid);
if (_exists)                          ds_grid_destroy(dg_doors);
if (_exists)                                          dg_doors = undefined;
