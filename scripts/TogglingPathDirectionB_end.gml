...
var          _exists = false;
             ...
             _exists = variable_instance_exists(id,  "dg_a");
if (_exists) _exists =               !is_undefined(   dg_a);
if (_exists) _exists =                ds_exists(      dg_a, ds_type_grid);
if (_exists)                          ds_grid_destroy(dg_a);
if (_exists)                                          dg_a = undefined;

             _exists = variable_instance_exists(id,  "dg_arrows");
if (_exists) _exists =               !is_undefined(   dg_arrows);
if (_exists) _exists =                ds_exists(      dg_arrows, ds_type_grid);
if (_exists)                          ds_grid_destroy(dg_arrows);
if (_exists)                                          dg_arrows = undefined;
