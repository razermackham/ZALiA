...
var _exists = false;
    ...
    _exists = variable_instance_exists(id,  "dl_inst");
if (_exists) _exists =      !is_undefined(   dl_inst);
if (_exists) _exists =       ds_exists(      dl_inst, ds_type_list);
if (_exists)                 ds_list_destroy(dl_inst);
if (_exists)                                 dl_inst = undefined;
