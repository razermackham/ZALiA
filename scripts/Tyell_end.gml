...
var _exists = false;
    ...
    _exists = variable_instance_exists(id,  "dg_anim");
if (_exists) _exists =      !is_undefined(   dg_anim);
if (_exists) _exists =       ds_exists(      dg_anim,ds_type_grid);
if (_exists)                 ds_grid_destroy(dg_anim);
if (_exists)                                 dg_anim=undefined;
